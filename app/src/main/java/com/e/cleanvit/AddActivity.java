...
public class AddActivity extends AppCompatActivity {
    ...
    private String landmark, dateTime, latitude, longitude, mobile, remarks, status = "Pending";
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(imageView.getDrawable().getConstantState() == getResources().getDrawable(R.mipmap.no_image).getConstantState())
                {
                    ...
                    temp = databaseReference.child("Complients").push();
            ...
            uploadTask
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            temp.child("Mobile").setValue(LogIn.regNo);
